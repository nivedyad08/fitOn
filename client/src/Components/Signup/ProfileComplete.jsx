        ...
        <form className="space-y-6" onSubmit={handleProfileComplete}>
          ...
          <div className="flex items-center justify-center w-full">
            <label
              ...
              className={`flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 ${showCoverImage ? 'h-auto' : 'dark:hover:bg-gray-800 dark:bg-gray-700'
                }`}
            >
              {
                showCoverImage ? (
                  <div className="h-full">
                    <img className="h-full w-full" id="selected-image" src={showCoverImage} alt="Selected Image" />
                  </div>
              ...
              <input id="dropzone-file" type="file" className="hidden" onChange={handleCoverPhotoChange} />
            </label>
